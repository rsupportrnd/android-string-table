...
object StringTableGenerator {
    ...
    fun generate(source: String, resPath: String, targetSheetName: String?, rowPositionColumnHeader: Int?, xmlFileName: String?) {
        ...
        Sheet2Strings.convert(getTargetSheet(targetSheetName, workbook), pathRes, rowPositionColumnHeader, xmlFileName)
        println("Completed.")
        inputStream.close()
    }
