...
public class StringTableGenerator {
    public static void generate(File source, String pathRes, String targetSheetName, String indexRowNum) throws IOException {
        ...
        Sheet2Strings.getInstance().convert(getTargetSheet(targetSheetName, workbook), res, Integer.parseInt(indexRowNum));
